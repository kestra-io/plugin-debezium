...
@NoArgsConstructor
@Schema(
    title = "Trigger a flow via a PostgreSQL change data capture event in real-time and create one execution per row.",
...
public class RealtimeTrigger extends AbstractDebeziumRealtimeTrigger implements PostgresInterface, AbstractDebeziumInterface {
    ...
    @Builder.Default
    protected Property<SslMode> sslMode = Property.ofValue(SslMode.DISABLE);
