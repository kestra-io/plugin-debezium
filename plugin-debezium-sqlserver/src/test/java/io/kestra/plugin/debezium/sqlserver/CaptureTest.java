...
class CaptureTest extends AbstractDebeziumTest {
    ...
    void run() throws Exception {
        ...
        FileSerde.reader(
            new BufferedReader(new InputStreamReader(storageInterface.get(TenantService.MAIN_TENANT, null, runOutput.getUris().get("deb.events")))), r -> events.add((Map<String, Object>) r)
        );
